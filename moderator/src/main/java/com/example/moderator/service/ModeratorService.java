...
//
//    @Transactional
//    public Moderator addModerator(UUID userId, UUID communityId) {
...
//
//    @Transactional
//    public void removeModerator(UUID userId, UUID communityId) {
...
//    public List<Report> viewReports(UUID moderatorId, UUID communityId) {
//        verifyModerator(moderatorId, communityId);
//        Command<List<Report>> command = new ViewReportsCommand(reportService, communityId);
...
//
//    @Transactional
//    public void removeThread(UUID moderatorId, UUID communityId, UUID threadId) {
//        verifyModerator(moderatorId, communityId);
//        Command<Void> command = new RemoveThreadCommand(threadId);
//        commandInvoker.execute(command);
//    }
//
//    @Transactional
